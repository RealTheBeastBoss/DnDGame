...
class Weapon:
    def __init__(self, name, cost, dmg, dmg_type, properties = []):
        self.name = name
        self.cost = cost
...
class Club(Weapon):
    def __init__(self):
        super().__init__("Club", 10, (1, 4), Damage.BLUDGEONING, [Properties.LIGHT])
class Dagger(Weapon):
    def __init__(self):
...
class Greatclub(Weapon):
    def __init__(self):
        super().__init__("Greatclub", 20, (1, 8), Damage.BLUDGEONING, [Properties.TWOHANDED])
class Handaxe(Weapon):
    def __init__(self):
        super().__init__("Handaxe", 500, (1, 6), Damage.SLASHING, [Properties.LIGHT, Properties.THROWN20_60])
class Javelin(Weapon):
    def __init__(self):
        super().__init__("Javelin", 50, (1, 6), Damage.PIERCING, [Properties.THROWN30_120])
class LightHammer(Weapon):
    def __init__(self):
        super().__init__("Light Hammer", 200, (1, 4), Damage.BLUDGEONING, [Properties.LIGHT, Properties.THROWN20_60])
class Mace(Weapon):
    def __init__(self):
        super().__init__("Mace", 500, (1, 6), Damage.BLUDGEONING)
class Quarterstaff(Weapon):
    def __init__(self):
        super().__init__("Quarterstaff", 20, (1, 4), Damage.BLUDGEONING, [Properties.VERSATILE1_8])
class Sickle(Weapon):
    def __init__(self):
        super().__init__("Sickle", 100, (1, 4), Damage.SLASHING, [Properties.LIGHT])
class Spear(Weapon):
    def __init__(self):
        super().__init__("Spear", 100, (1, 6), Damage.PIERCING, [Properties.THROWN20_60, Properties.VERSATILE1_8])
...
class Dart(Weapon):
    def __init__(self):
        super().__init__("Dart", 5, (1, 4), Damage.PIERCING, [Properties.FINESSE, Properties.THROWN20_60])
class Shortbow(Weapon):
    def __init__(self):
        super().__init__("Shortbow", 2500, (1, 6), Damage.PIERCING, [Properties.AMMO80_320, Properties.TWOHANDED])
class Sling(Weapon):
    def __init__(self):
        super().__init__("Sling", 10, (1, 4), Damage.BLUDGEONING, [Properties.AMMO30_120])
...
class Blowgun(Weapon):
    def __init__(self):
        super().__init__("Blowgun", 1000, 1, Damage.PIERCING, [Properties.AMMO25_100, Properties.LOADING])
...
class Net(Weapon):
    def __init__(self):
        super().__init__("Net", 100, 0, Damage.BLUDGEONING, [Properties.THROWN5_15])